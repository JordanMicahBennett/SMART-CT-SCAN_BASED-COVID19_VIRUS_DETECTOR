...
4. Download **this x ray covid19 dataset that I've collated** (that I'm now uploading) from [Dr. Cohen's collation](https://github.com/ieee8023/covid-chestxray-dataset).

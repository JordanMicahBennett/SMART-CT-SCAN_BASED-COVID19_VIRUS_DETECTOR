...
My repository includes a few fixes to [the original repository](https://github.com/JohnChangUK/Pneumonia-Kaggle), including a simple user interface to facilitate command-free automated covid19 diagnosis.

...
* [Molecular and Serology Tests](http://www.jamaicaobserver.com/latestnews/Jamaica_can_now_test_for_COVID-19): Up to **5 days** before results are returned](
...
2. Take note of the [saved weights](https://github.com/JohnChangUK/Pneumonia-Kaggle/blob/master/vgg19.h5) from the original repository, and ensure both the code and weights are in same place.

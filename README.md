...
The aim is to develop a quick way to detect the nCov 2019 (Coronavirus 2019/2020, also called "Covid-19" or "SARS-CoV-2") strain, with the plan to use artificial neural networks or other machine learning model types.
